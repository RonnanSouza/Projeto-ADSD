...
class Escalonador:
    ...
    def __init__(self):
        """
            Quando iniciamos o escalonador, temos as duas filas vazias, uma para cada classe de elementos e logo definimos quando será a chegada
            do primeiro elemento de cada classe (considerando que o tempo de chegada do proximo elemento de classe 1 segue a distribuição uniforme
            entre 1 e 10, enquanto a classe 2 é entre 1 e 5). Também temos o servidor livre, uma vez que não há nenhum elemento para ser atendido.
        """
        self.tam_fila1 = 0
        self.tam_fila2 = 0
