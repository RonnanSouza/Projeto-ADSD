...
def relatorio():
    """
    Imprime informações sobre a simulação
    """
...
# Arrays utilizados para guardar dados acerca da simulação
esperaCaixaE = []
esperaCaixaI = []
esperaGuiche = []
filaCaixaE = []
...
# Converte Arrays de modo que possam ser utilizados pelo package numpy
